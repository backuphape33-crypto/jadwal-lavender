...
const employees = {
  'Hotel Lavender': [
    ...
    { id: 4, name: 'Fahmi', department: 'Housekeeping', code: 'HK' },
    { id: 5, name: 'Ady', department: 'Housekeeping', code: 'HK' },
    { id: 6, name: 'Fadlan', department: 'Housekeeping', code: 'HK' },
    { id: 7, name: 'Saeful', department: 'Housekeeping', code: 'HK' },
    { id: 8, name: 'Salman', department: 'General', code: 'GA' },
...
const shiftOptions = [
  ...
  { id: 'GEN1', label: 'GEN (07-19)', color: 'bg-teal-600 text-white' },
